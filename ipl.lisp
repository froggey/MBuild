...
;; Read the config file. This is a cross-compiler path, not a native path.
...
(setf *default-pathname-defaults* (pathname (concatenate 'string
                                                         "REMOTE:"
                                                         *build-directory*
                                                         "Mezzano/")))
;; Point MEZZANO.FILE-SYSTEM::*HOME-DIRECTORY* at the home directory containing the libraries.
(setf mezzano.file-system::*home-directory* (pathname (concatenate 'string
                                                         "REMOTE:"
                                                         *build-directory*
                                                         "Home/")))
...
(sys.int::copy-file (merge-pathnames "Desktop.jpg" (user-homedir-pathname))
                    "LOCAL:>Desktop.jpeg"
                    '(unsigned-byte 8))
